...
export const baseControlClasses =
    "w-full px-4 py-2.5 border border-purple-100 rounded-lg text-sm \
...
export const TI_CLASSES = {
    wrapper: "group p-4 sm:p-5 rounded-xl shadow-sm bg-white border-l-4 hover:shadow-md transition-all duration-300 border border-purple-400",
