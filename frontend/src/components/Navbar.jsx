            ...
            >
              <div className="relative">
                {currentUser.avatar ? (
                  ...
                  <div className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-purple-500 text-white font-semibold shadow-lg">
                    {currentUser.name?.[0]?.toUpperCase() || "U"}
                  </div>
                )}

                <div className="absolute -bottom-0 -right-0 translate-x-0.5 translate-y-0.5 w-3 h-3 bg-green-400 rounded-full border-2 border-white animate-pulse" />
              </div>
