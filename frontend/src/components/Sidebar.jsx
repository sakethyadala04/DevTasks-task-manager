        ...
        <>
            ...
            <div className={SIDEBAR_CLASSES.desktop}>
                <div className=' p-5 border-b border-purple-100 lg:block hidden '>
                    <div className=' flex item-cemter gap-3 '>
                        <div className=' w-10 h-10 rounded-full bg-gradient-to-tr from-blue-500 to-purple-600
                     flex items-center justify-center text-white font-bold text-lg shadow-md '>
                            {initial}
                        </div>
                        <div>
                            <h2 className=' text-lg font-semibold text-gray-800 '>Hey  {username}</h2>
                ...
                <div className=' p-4 space-y-4 overflow-y-auto flex-1'>
                    ...
                    <div className=' mt-auto py-6 lg:block hidden '>
            ...
            {mobileOpen && (
                <div className=' fixed inset-0 z-50 flex '>
                    ...
                    <div className={SIDEBAR_CLASSES.mobileDrawer} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className=' flex item-cemter gap-3 mb-6 '>
                            <div className=' w-10 h-10 rounded-full bg-gradient-to-tr from-blue-500 to-purple-600
                     flex items-center justify-center  text-white font-bold text-lg shadow-md '>
                                {initial}
                            </div>
